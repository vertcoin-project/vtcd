...
//
// NOTE: This is a ltcd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []vtcutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a btcwallet extension.
func (c *Client) ListAddressTransactions(addresses []vtcutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
